...
class SliderComponent extends HTMLElement {
  constructor() {
    ...
    this.pageTotalElement = this.querySelector(
    ...
    this.slideScrollPosition =
      event.currentTarget.name === 'next'
        ? this.slider.scrollLeft +
          step * this.sliderLastItem.clientWidth
        : this.slider.scrollLeft -
          step * this.sliderLastItem.clientWidth
...
class SlideshowComponent extends SliderComponent {
  constructor() {
    ...
    this.sliderControlLinksArray = Array.from(
      this.sliderControlWrapper.querySelectorAll(
  ...
  setAutoPlay() {
    ...
    this.addEventListener(
      'mouseover',
      this.focusInHandling.bind(this)
    )
    this.addEventListener(
      'mouseleave',
      this.focusOutHandling.bind(this)
    )
